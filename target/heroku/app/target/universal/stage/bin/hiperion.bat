@REM hiperion launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM HIPERION_config.txt found in the HIPERION_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%HIPERION_HOME%"=="" set "HIPERION_HOME=%~dp0\\.."

set "APP_LIB_DIR=%HIPERION_HOME%\lib\"
...
set "CFG_FILE=%HIPERION_HOME%\HIPERION_config.txt"
set CFG_OPTS=
if exist "%CFG_FILE%" (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running hiperion.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !HIPERION_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
